...
export default function Payapp() {
  ...
  const data = {
    ...
    images: [
      { src: "/images/img_ud_landing1.webp", alt: "" },
      { src: "/images/img_ud_landing2.webp", alt: "" },
      { src: "/images/img_ud_landing3.webp", alt: "" },
      { src: "/images/img_ud_landing4.webp", alt: "" },
      { src: "/images/img_ud_landing5.webp", alt: "" },
      { src: "/images/img_ud_landing6.webp", alt: "" },
    ],
  };
  return (
    <>
